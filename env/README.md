...
Secrets for `discrete-event-systems/des-mcp-server.rs` are **committed, encrypted**, with [sops] + [age],
...
```sh
just env-docker-run dev ghcr.io/discrete-event-systems/des-mcp-server.rs:dev
